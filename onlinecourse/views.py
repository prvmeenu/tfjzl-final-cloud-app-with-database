...
def show_exam_result(request, course_id, submission_id):
    ...
    for question in questions:
        question.choice_set.filter(is_correct=True) # Get all correct choices for the question selected_choices = choices.filter(question=question) # Get the user's selected choices for the question
